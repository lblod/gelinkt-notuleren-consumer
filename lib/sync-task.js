...
const TASK_NOT_STARTED_STATUS = `http://lblod.data.gift/sync-task-statuses/not-started`;
const TASK_ONGOING_STATUS = `http://lblod.data.gift/sync-task-statuses/ongoing`;
const TASK_SUCCESS_STATUS = `http://lblod.data.gift/sync-task-statuses/success`;
const TASK_FAILED_STATUS = `http://lblod.data.gift/sync-task-statuses/failure`;
