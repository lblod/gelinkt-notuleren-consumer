...
import { PUBLIC_GRAPH, SYNC_FILES_ENDPOINT } from '../config';
import fetch from 'node-fetch';
import DeltaFile from './delta-file';

const TASK_NOT_STARTED_STATUS = 'http://lblod.data.gift/gelinkt-notuleren-functionarissen-consumer-sync-task-statuses/not-started';
const TASK_ONGOING_STATUS = 'http://lblod.data.gift/gelinkt-notuleren-functionarissen-consumer-sync-task-statuses/ongoing';
const TASK_SUCCESS_STATUS = 'http://lblod.data.gift/gelinkt-notuleren-functionarissen-consumer-sync-task-statuses/success';
const TASK_FAILED_STATUS = 'http://lblod.data.gift/gelinkt-notuleren-functionarissen-consumer-sync-task-statuses/failure';
